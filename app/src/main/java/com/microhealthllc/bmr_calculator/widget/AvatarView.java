...
package com.microhealthllc.bmr_calculator.widget;
...
import com.microhealthllc.bmr_calculator.widget.outlineprovider.RoundOutlineProvider;


/**
 * A simple view that wraps an avatar.
 */
public class AvatarView extends android.support.v7.widget.AppCompatImageView implements Checkable {
