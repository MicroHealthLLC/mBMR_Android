...
public class BmiChartRed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bmichartred);
       ...
       // generateInitialLineData();
        ...
        viewmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(BmiChartRed.this, LogActivity.class);
                startActivity(i);
            }
        });
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.enter_edit_data:
                {
                  ...
                  Intent i = new Intent(BmiChartRed.this, BasicSettings.class);
                  startActivity(i);
                ...
                case R.id.bmi_graph:
                    ...
                    Intent i = new Intent(BmiChartRed.this, LineColumnDependencyActivity.class);
                    startActivity(i);
             ...
             /*   case R.id.unitsettings:
                //    MaterialDialog.Builder builder = new MaterialDialog.Builder(BmiChart.this);
                 ...
                 //  unitoptions();
                    ...
                    break;*/
                case R.id.bmi_logs :
                    Intent it = new Intent(BmiChartRed.this, LogActivity.class);
                    startActivity(it);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    //    mCurrentSelectedPosition = 2;
                        Intent j = new Intent(BmiChartRed.this, LogActivity.class);
                        startActivity(j);
                        break;
                    case R.id.navigation_item_4:
                     //   mCurrentSelectedPosition = 3;
                        new LovelyStandardDialog(BmiChartRed.this)
                                ...
                                .setPositiveButton(android.R.string.ok, new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(BmiChartRed.this, "positive clicked", Toast.LENGTH_SHORT).show();

                                        Intent i = new Intent(BmiChartRed.this, BmiChartRed.class);
                                        startActivity(i);
                                    }
                                })
                    ...
                    case R.id.navigation_item_5:
                        Intent about = new Intent (BmiChartRed.this, About.class);
                        startActivity(about);


                        break;
                    case R.id.navigation_item_6:
                        Intent js = new Intent(BmiChartRed.this, LineColumnDependencyActivity.class);
                        startActivity(js);
